...
export class MatchComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.matchService
      ...
      .subscribe(
        (res: HttpResponse<IMatch[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInMatchs(): void {
    this.eventSubscriber = this.eventManager.subscribe('matchListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMatch[] | null, headers: HttpHeaders, page: number): void {
